export const LoginButton = () => {
  return (
    <button class="overflow-hidden relative w-32 p-2 h-12 bg-black text-white border-none rounded-md text-xl font-bold cursor-pointer z-10 group font-edu tracking-widest mt-4">
      LOGIN
